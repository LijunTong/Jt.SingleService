...
namespace Jt.SingleService.Controllers
{
    ...
    {
        private IRoleActionSvc _service;
        private JwtHelper _jwtHelper;

        public RoleActionController(IRoleActionSvc service, JwtHelper jwtHelper)
        {
            _service = service;
        ...
        public async Task<ActionResult> Insert([FromBody] RoleAction entity)
        {
        ...
        public async Task<ActionResult> Update([FromBody] RoleAction entity)
        {
        ...
        public async Task<ActionResult> Get(int id)
        {
            ...
            return Ok(ApiResponse<RoleAction>.GetSucceed(data));
        }
        ...
        public async Task<ActionResult> List()
        {
            ...
            return Ok(ApiResponse<List<RoleAction>>.GetSucceed(data));
        }
