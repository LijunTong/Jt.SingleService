...
{
    [Route("CodeSchemeDetials")]
    public class CodeSchemeDetialsController : BaseController
    {
        private ICodeSchemeDetialsSvc _service;
        private JwtHelper _jwtHelper;

        public CodeSchemeDetialsController(ICodeSchemeDetialsSvc service, JwtHelper jwtHelper)
        {
            _service = service;
        ...
        public async Task<ActionResult> Insert([FromBody] CodeSchemeDetials entity)
        {
        ...
        public async Task<ActionResult> Update([FromBody] CodeSchemeDetials entity)
        {
        ...
        public async Task<ActionResult> Get(int id)
        {
            ...
            return Ok(ApiResponse<CodeSchemeDetials>.GetSucceed(data));
        }
        ...
        public async Task<ActionResult> List()
        {
            ...
            return Ok(ApiResponse<List<CodeSchemeDetials>>.GetSucceed(data));
        }
