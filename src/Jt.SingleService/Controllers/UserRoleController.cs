...
namespace Jt.SingleService.Controllers
{
    ...
    {
        private IUserRoleSvc _service;
        private JwtHelper _jwtHelper;

        public UserRoleController(IUserRoleSvc service, JwtHelper jwtHelper)
        {
            _service = service;
        ...
        public async Task<ActionResult> Insert([FromBody] UserRole entity)
        {
        ...
        public async Task<ActionResult> Update([FromBody] UserRole entity)
        {
        ...
        public async Task<ActionResult> Get(int id)
        {
            ...
            return Ok(ApiResponse<UserRole>.GetSucceed(data));
        }
        ...
        public async Task<ActionResult> List()
        {
            ...
            return Ok(ApiResponse<List<UserRole>>.GetSucceed(data));
        }
