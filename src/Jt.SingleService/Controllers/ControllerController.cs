...
namespace Jt.SingleService.Controllers
{
    ...
    {
        private IControllerSvc _service;
        private JwtHelper _jwtHelper;

        public ControllerController(IControllerSvc service, JwtHelper jwtHelper)
        {
            _service = service;
        ...
        public async Task<ActionResult> Insert([FromBody] Core.Tables.Controller entity)
        {
        ...
        public async Task<ActionResult> Update([FromBody] Core.Tables.Controller entity)
        {
        ...
        public async Task<ActionResult> Get(int id)
        {
            ...
            return Ok(ApiResponse<Core.Tables.Controller>.GetSucceed(data));
        }
        ...
        public async Task<ActionResult> List()
        {
            ...
            return Ok(ApiResponse<List<Core.Tables.Controller>>.GetSucceed(data));
        }
