...
namespace Jt.SingleService.Controllers
{
    ...
    {
        private IActionSvc _service;
        private JwtHelper _jwtHelper;

        public ActionController(IActionSvc service, JwtHelper jwtHelper)
        {
            _service = service;
        ...
        public async Task<ActionResult> Insert([FromBody] Core.Tables.Action entity)
        {
        ...
        public async Task<ActionResult> Update([FromBody] Core.Tables.Action entity)
        {
        ...
        public async Task<ActionResult> Get(int id)
        {
            ...
            return Ok(ApiResponse<Core.Tables.Action>.GetSucceed(data));
        }
        ...
        public async Task<ActionResult> List()
        {
            ...
            return Ok(ApiResponse<List<Core.Tables.Action>>.GetSucceed(data));
        }
