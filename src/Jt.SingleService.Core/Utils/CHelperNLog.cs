...
namespace Jt.SingleService.Core.Utils
{
    ...
    public class NLogHelper
    {
        ...
        public NLogHelper(string name) : this(NLog.Web.NLogBuilder.ConfigureNLog("Configs/NLog.config").GetLogger(name))
        {
        }
        ...
        static NLogHelper()
        {
            Default = new NLogHelper(NLog.Web.NLogBuilder.ConfigureNLog("Configs/NLog.config").GetLogger("Default"));
        }
