...
namespace Jt.Cms.Controllers
{
    ...
    {
        private readonly IArticleTagSvc _service;

        public ArticleTagController(IArticleTagSvc service, JwtHelper jwtHelper,
            IIDSvc snowflake) : base(jwtHelper)
        {
            _service = service;
        }
        ...
        public async Task<ActionResult> Insert([FromBody] ArticleTag entity)
        {
        ...
        public async Task<ActionResult> Update([FromBody] ArticleTag entity)
        {
            entity.Updater = GetUser()?.Id;
