...
namespace Jt.Cms.Controllers
{
    ...
    {
        private readonly IColumnSvc _service;

        public ColumnController(IColumnSvc service, JwtHelper jwtHelper) : base(jwtHelper)
        {
            _service = service;
        }
        ...
        public async Task<ActionResult> Insert([FromBody] Column entity)
        {
        ...
        public async Task<ActionResult> Update([FromBody] Column entity)
        {
            entity.Updater = GetUser()?.Id;
