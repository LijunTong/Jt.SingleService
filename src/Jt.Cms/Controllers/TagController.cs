...
namespace Jt.Cms.Controllers
{
    ...
    {
        private readonly ITagSvc _service;

        public TagController(ITagSvc service, JwtHelper jwtHelper) : base(jwtHelper)
        {
            _service = service;
        }
        ...
        public async Task<ActionResult> Insert([FromBody] Tag entity)
        {
        ...
        public async Task<ActionResult> Update([FromBody] Tag entity)
        {
            entity.Updater = GetUser()?.Id;
