...
namespace Jt.Cms.Controllers
{
    ...
    {
        private readonly IArticleReadSvc _service;

        public ArticleReadController(IArticleReadSvc service, JwtHelper jwtHelper) : base(jwtHelper)
        {
            _service = service;
        }
        ...
        public async Task<ActionResult> Insert([FromBody] ArticleRead entity)
        {
        ...
        public async Task<ActionResult> Update([FromBody] ArticleRead entity)
        {
            entity.Updater = GetUser()?.Id;
