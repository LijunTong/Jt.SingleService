...
namespace Jt.Cms.Controllers
{
    ...
    {
        private readonly ICommentLikeSvc _service;

        public CommentLikeController(ICommentLikeSvc service, JwtHelper jwtHelper) : base(jwtHelper)
        {
            _service = service;
        }
        ...
        public async Task<ActionResult> Insert([FromBody] CommentLike entity)
        {
        ...
        public async Task<ActionResult> Update([FromBody] CommentLike entity)
        {
