...
namespace Jt.Cms.Controllers
{
    ...
    {
        private readonly IArticleCommentSvc _service;

        public ArticleCommentController(IArticleCommentSvc service, JwtHelper jwtHelper) : base(jwtHelper)
        {
            _service = service;
        }
        ...
        public async Task<ActionResult> Insert([FromBody] ArticleComment entity)
        {
        ...
        public async Task<ActionResult> Update([FromBody] ArticleComment entity)
        {
            entity.Updater = GetUser()?.Id;
