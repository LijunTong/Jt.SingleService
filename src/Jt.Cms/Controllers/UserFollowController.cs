...
namespace Jt.Cms.Controllers
{
    ...
    {
        private readonly IUserFollowSvc _service;

        public UserFollowController(IUserFollowSvc service, JwtHelper jwtHelper) : base(jwtHelper)
        {
            _service = service;
        }
        ...
        public async Task<ActionResult> Insert([FromBody] UserFollow entity)
        {
        ...
        public async Task<ActionResult> Update([FromBody] UserFollow entity)
        {
            entity.Updater = GetUser()?.Id;
