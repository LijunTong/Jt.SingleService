...
{
    [Route("ArticleCollect")]
    public class ArticleCollectController : BaseController
    {
        private readonly IArticleCollectSvc _service;

        public ArticleCollectController(IArticleCollectSvc service, JwtHelper jwtHelper) : base(jwtHelper)
        {
            _service = service;
        }
        ...
        public async Task<ActionResult> Insert([FromBody] ArticleCollect entity)
        {
        ...
        public async Task<ActionResult> Update([FromBody] ArticleCollect entity)
        {
            entity.Updater = GetUser()?.Id;
